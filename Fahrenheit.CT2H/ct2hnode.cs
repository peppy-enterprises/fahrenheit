...
public static class FhCtSyntaxExtensions
{
    ...
    {
        return $$"""
/* [ct2h {{DateTime.UtcNow.ToString("dd/M/yy HH:mm")}}]
 * This file was generated by Fahrenheit.CT2H (https://github.com/fkelava/fahrenheit/).
 * 
 * Source file: {{Path.GetFileName(CT2HConfig.FilePath)}}
 */

namespace {{CT2HConfig.DefaultNamespace}};
...
""";
    ...
    {
        return $"    [FieldOffset(0x{stn.Offset})] public {stn.Name} __{stn.Name};";
    }
