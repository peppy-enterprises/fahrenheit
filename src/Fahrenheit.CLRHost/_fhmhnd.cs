...
public class FhMethodHandle<T> where T : Delegate {
    ...
    public bool try_hook()   { return _handle_valid && FhCLRHost.hook  (_fn_addr, _hook_fn, out _orig_fn); }
    public bool try_unhook() { return _handle_valid && FhCLRHost.unhook(_fn_addr, _hook_fn, out _orig_fn); }
}
