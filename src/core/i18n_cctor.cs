 ...
 *
 * Since there are a _lot_ of locales according to ISO 639, they're separated out
 * into this file to avoid cluttering up the main localization code.
 */
...
public sealed partial class FhLocalization {
    ...
    static FhLocalization() {
        ...
        _s_locales = new Dictionary<string, LocaleData>(_s_locale_ids.Length);

        foreach (string lang_id in _s_locale_ids) {
            _s_locales.Add(lang_id, []);
        }
    }
