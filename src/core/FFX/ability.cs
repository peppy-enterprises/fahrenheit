...
public partial struct Ability {
    ...
    [FieldOffset(0x11)] public ElementalFlags       elem_strike;
    [FieldOffset(0x12)] public ElementalFlags       elem_absorb;
    [FieldOffset(0x13)] public ElementalFlags       elem_ignore;
    [FieldOffset(0x14)] public ElementalFlags       elem_resist;
    [FieldOffset(0x15)] public ElementalFlags       elem_weak;
    ...
    [FieldOffset(0x62)] public AutoAbilityMap       auto_abilities;
