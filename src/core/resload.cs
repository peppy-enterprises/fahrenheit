...
public sealed class FhResources {
    ...
    internal readonly FhRuntimeHandle<IFhResourceLoader> impl_handle = new(); // RT connects here.
    ...
    public bool load_texture_from_disk(FhTexture texture) {
        return impl_handle.get(out IFhResourceLoader? impl) && impl.load_texture_from_disk(texture);
    }
    ...
    public bool load_game_texture_2d(FhTexture texture) {
        return impl_handle.get(out IFhResourceLoader? impl) && impl.load_game_texture_2d(texture);
    }
    ...
    public bool load_game_texture_3d(FhTexture texture) {
        return impl_handle.get(out IFhResourceLoader? impl) && impl.load_game_texture_3d(texture);
    }
    ...
    public bool load_game_texture_cubemap(FhTexture texture) {
        return impl_handle.get(out IFhResourceLoader? impl) && impl.load_game_texture_cubemap(texture);
    }
    ...
    public bool unload_texture(FhTexture texture) {
        return impl_handle.get(out IFhResourceLoader? impl) && impl.unload_texture(texture);
    }
}
