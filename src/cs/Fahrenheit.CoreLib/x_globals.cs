...
public static unsafe class FhXGlobals {
	...
	public static FhXAtelRequest* atel_request_list = (FhXAtelRequest*)(game_base + 0xD35D68);
	public static FhXAtelBasicWorker* cur_atel_worker = (FhXAtelBasicWorker*)(game_base + 0xF270A4);
	public static FhXAtelControllerWorker* cur_ctrl_atel_worker = (FhXAtelControllerWorker*)(game_base + 0xF26AE8);
