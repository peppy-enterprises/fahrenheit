...
public unsafe struct SaveData {
    ...
    [FieldOffset(0x279)]  public       byte           calm_lands_quest_progression_flags;
    [FieldOffset(0x287)]  public       byte           belgemine_fight_progression_flags;
    [FieldOffset(0x28B)]  public       byte           monster_arena_unlock_quest_progression_flags;
    [FieldOffset(0x2F0)]  public       byte           energy_blast_progression_flags;
    [FieldOffset(0x300)]  public       byte           remiem_temple_progression_flags;
    [FieldOffset(0x3BE)]  public       byte           omega_ruins_progression_flags;
    [FieldOffset(0x3C0)]  public       byte           home_progression_flags;
    [FieldOffset(0x3F1)]  public       byte           thunder_plains_progression_flags;
    ...
    [FieldOffset(0xC89)]  public       byte           dark_valefor_completion_flags;
    [FieldOffset(0xC8A)]  public       byte           dark_ifrit_completion_flags;
    [FieldOffset(0xC8B)]  public       byte           dark_ixion_completion_flags;
    [FieldOffset(0xC8C)]  public       byte           dark_shiva_completion_flags;
    [FieldOffset(0xC8D)]  public       byte           dark_bahamut_completion_flags;
